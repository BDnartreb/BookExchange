...
<section class="gallery">
    <div class="gallery-title">
        ...
        <form class="book-search" method="get" action="index.php">
            ...
            <input class="search-button" type="submit" value=""><i class="fa-thin fa-magnifying-glass"></i>
            ...
            <input class="search" type="text" name="book" id="book" placeholder="Rechercher un livre" size="30" maxlength="120">
       </form>
    </div>
